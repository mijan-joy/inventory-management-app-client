...
const Banner = () => {
    return (
        <div className="bg-black text-white py-10 text-center mt-10">
            <p className="uppercase text-rakib-400 tracking-widest">
                User based inventory management system
            </p>
            <h2 className="font-bold text-6xl pt-6">Real time updates</h2>
            <h2 className="font-bold text-5xl pt-3 animate-pulse">
                Deliver, restock, manage. Simple!
            </h2>
            <p className="text-gray-400 font-semibold text-xl pt-6 tracking-wide mb-5">
